...
// show records
$opdrachtsql = "SELECT * FROM opdracht WHERE vakid = '$id'AND semester = '4' ORDER BY semester DESC, gate, sprint ASC";
    ...
    <div class="opdracht"> 
        ...
        <?php foreach ($opdrachtdata as $filtervakdata){?>
            <div class="opdrachtcontent">
                ...
                <h3 class="subhead">Gate: <?=$filtervakdata['gate']?></h3>
                <h3 class="subhead">Semester: <?=$filtervakdata['semester']?></h3>
